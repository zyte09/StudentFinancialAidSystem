    ...
    public static void main(String[] args){
        ...
        while (true) {
            ...
            if (!option.matches("[1-6]")) {
                ...
                input.nextLine();
                    ...
                    String studentMajor = input.nextLine().toUpperCase().trim();
                ...
                if (i == -1) {
                    ...
                    if (input.hasNextDouble()) {
                        ...
                        System.out.println("INVALID INPUT!! PLEASE ENTER A VALID GWA BETWEEN 0 AND 100.");
                        input.next();
                    }
                }
                input.nextLine();
                ...
                if (i == -1) {
                    ...
                    String formatMajor = studentMajor.replaceAll("\\s|-", "").toUpperCase(); // remove dashes and space

                    //Scholarships specific course
                    ...
                    if (applyOtherScholarship.equals("Y")) {
                        ...
                        //Ask the user to input other scholarship number to apply
        ...
        //Display student info
                ...
                if (i == -1) {
                    ...
                    String selectedScholarship = selectedScholarshipMap.get(studentCode);
